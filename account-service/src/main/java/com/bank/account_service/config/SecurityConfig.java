...
/**
 * The gateway also validates tokens, but this service validates them again on
 * its own. That is deliberate: the service port is reachable directly, so
 * relying on the gateway alone would make all authorization optional for
 * anyone who can reach port 8082.
 */
@Configuration
public class SecurityConfig {
    ...
    // In Docker, Keycloak is on the host and must be reached via
